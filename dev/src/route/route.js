...
export const routes = [
  ...
  {
    label: "分页器（FPagination）",
    path: "/pagination",
    element: (
      <>
        <h1>分页器（FPagination）</h1>
        <div>
          <Component24 />
        </div>
      </>
...
import { FTabTest as Component39 } from "../test/tab";
import { FTableTest as Component40 } from "../test/table";
import { FTagTest as Component41 } from "../test/tag";
import { FToastTest as Component42 } from "../test/toast";
import { ClostTest as Component43 } from "../test/toast";
import { ApiTest as Component44 } from "../test/toast";
import { QuickTest as Component45 } from "../test/toast";
export const routes = [
  {
    label: "按钮（FButton）",
    path: "/button",
